...
## Project Structure
    ...
    ├── cbj_inventory_track_36676  # Django project configurations
...
1. Clone this repo and `cd cbj_inventory_track_36676`
...
2. Clone this repo and `cd cbj_inventory_track_36676`
